...
class Register extends Component {
   ...
   submit() {
      ...
      this.props.register(user, () => {this.showSignIn(user)});
   }

   showSignIn(user) {
      console.log(this.props);
      if(!this.props.Errs.length)
   ...
   formValid() {
      ...
      return s.email && s.lastName && s.password && s.password === s.passwordTwo && s.password.trim() !== ""
       && s.termsAccepted;
   }
      ...
      return (
         <div className="container">
            ...
            {this.state.password !== this.state.passwordTwo ?
               ...
               </Alert> : this.state.password.trim() === "" ?
               <Alert bsStyle="warning">
                  Password Invalid
               </Alert> : ''}
